...
plt.savefig(os.path.join(path, "vgg_predicts_centrist.pdf"))
...
plt.savefig(os.path.join(path, "vgg_voting_predicts_centrist.pdf"))
...
plt.savefig(os.path.join(path, "vgg_threshold_voting_predicts_centrist.pdf"))

plt.figure(3, figsize=(10, 4))
plt.plot(times, error)
plt.xlabel("time [s]")
plt.ylabel("error value]")
plt.savefig(os.path.join(path, "error_vgg_distance.pdf"))
